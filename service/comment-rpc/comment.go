...
import (
	...
	"MaoerMovie/service/comment-rpc/internal/server"
...
var configFile = flag.String("f", "D:\\golangPro\\MaoerMovie\\service\\comment-rpc\\etc\\comment.yaml", "the config file")
