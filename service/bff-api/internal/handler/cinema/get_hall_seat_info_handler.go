...
func GetHallSeatInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.HallSeatInfoRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.Error(w, err)
			return
		}

		l := cinema.NewGetHallSeatInfoLogic(r.Context(), svcCtx)
		resp, err := l.GetHallSeatInfo(&req)
