...
func GetConditionListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ConditionListRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.Error(w, err)
			return
		}

		l := cinema.NewGetConditionListLogic(r.Context(), svcCtx)
		resp, err := l.GetConditionList(&req)
